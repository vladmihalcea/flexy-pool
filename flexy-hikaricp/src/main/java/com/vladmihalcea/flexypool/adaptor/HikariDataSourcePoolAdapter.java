...
/**
 * <code>HikariDataSourcePoolAdapter</code> extends {@link AbstractPoolAdapter} and it adapts the required API to
 ...
 * @since 1.0
 */
public class HikariDataSourcePoolAdapter extends AbstractPoolAdapter<HikariDataSource> {
    ...
    public HikariDataSourcePoolAdapter(ConfigurationProperties<HikariDataSource, Metrics, PoolAdapter<HikariDataSource>> configurationProperties) {
