...
/**
 * BasicDataSourceIntegrationTest - Bitronix Integration Test
 *
 * @author Vlad Mihalcea
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration
public class BasicDataSourceIntegrationTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(BasicDataSourceIntegrationTest.class);
