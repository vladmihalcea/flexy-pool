...
/**
 * BoneCPDataSourceIntegrationTest - BasicDataSource Integration Test
 *
 * @author Vlad Mihalcea
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = "classpath:spring/applicationContext-test.xml")
public class BoneCPDataSourceIntegrationTest extends AbstractPoolAdapterIntegrationTest {
